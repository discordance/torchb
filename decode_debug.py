...
generated = np.load("generated/jazz1/gen60000.000000.npy")
witness = np.load("encoded/jazz1.npy")
np.random.shuffle(witness)
# generated = generated*np.max(witness)
...
with tf.Session() as sess:
    with tf.device("/cpu:0"):
        ...
        CodedX = tf.placeholder("float", [None, 128],  name='coded_input_layer')
        ...
        result = sess.run(layer_2, feed_dict={CodedX:witness,is_training:0})
        for e in result:
